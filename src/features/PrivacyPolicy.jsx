        ...
        <div style={{ minHeight: '100vh', background: C.bg, color: C.text }}>
            ...
            <main style={{ padding: 20, paddingBottom: 80 }}>
                ...
                <Section title="1. מבוא">
                    <p>
                        ברוכים הבאים ל-AmirNet (להלן: <strong style={{ color: 'white' }}>"האפליקציה"</strong> או <strong style={{ color: 'white' }}>"השירות"</strong>).
                    ...
                    <p>
                        <strong style={{ color: 'white' }}>בעל השליטה במידע (Data Controller):</strong> AmirNet.
                    </p>
                    <p>
                ...
                <Section title="2. המידע שאנו אוספים">
                    ...
                    <p><strong style={{ color: 'white' }}>2.1 מידע שנמסר על ידך ישירות:</strong></p>
                    ...
                    <p><strong style={{ color: 'white' }}>2.2 מידע שנאסף באופן אוטומטי:</strong></p>
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                    ...
                    <p><strong style={{ color: 'white' }}>2.3 נתוני שימוש ואנליטיקה:</strong></p>
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                ...
                <Section title="3. מטרות איסוף המידע">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li><strong style={{ color: 'white' }}>מתן השירות:</strong> יצירת חשבון, אימות זהות, ניהול מנויים, ושמירת התקדמות הלמידה</li>
                        <li><strong style={{ color: 'white' }}>התאמה אישית:</strong> הצגת שאלות ומילים מותאמות לרמת המשתמש, יצירת שאלות AI מבוססות על המילים הקשות שלך</li>
                        <li><strong style={{ color: 'white' }}>אנליטיקה ושיפור השירות:</strong> הבנת דפוסי שימוש, שיפור חוויית המשתמש, תיקון שגיאות, וזיהוי בעיות ביצועים</li>
                        <li><strong style={{ color: 'white' }}>תקשורת:</strong> שליחת הודעות שירות חיוניות (למשל, שינויים בתנאי השימוש)</li>
                    </ul>
                </Section>
                ...
                <Section title="4. הבסיס החוקי לעיבוד המידע">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li><strong style={{ color: 'white' }}>הסכמה:</strong> בעת ההרשמה לשירות, אתה מסכים לאיסוף ועיבוד המידע כמתואר במדיניות זו</li>
                        <li><strong style={{ color: 'white' }}>קיום חוזה:</strong> עיבוד המידע נדרש לצורך מתן השירות שהתבקש על ידך, לרבות ניהול חשבון, שמירת התקדמות, ומתן גישה לתכנים בהתאם לרמת המנוי</li>
                        <li><strong style={{ color: 'white' }}>אינטרס לגיטימי:</strong> לצורך אבטחת המערכת, מניעת שימוש לרעה, ושיפור השירות</li>
                    </ul>
                    <p>
                ...
                <Section title="5. שיתוף מידע עם צדדים שלישיים">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        ...
                        <li>
                            <strong style={{ color: 'white' }}>ElevenLabs</strong> — שירות המרת טקסט לדיבור (TTS) להשמעת מילים באנגלית.
                            מקבל טקסט בלבד (מילה או משפט), ללא מידע מזהה.
                            <br />
                            <span style={{ fontSize: 12 }}>מדיניות פרטיות: elevenlabs.io/privacy</span>
                        </li>
                        <li>
                            <strong style={{ color: 'white' }}>Google</strong> — שירות OAuth להתחברות מהירה.
                ...
                <Section title="7. אבטחת מידע">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li><strong style={{ color: 'white' }}>הצפנה:</strong> תקשורת מוצפנת באמצעות HTTPS/TLS. סיסמאות מוצפנות באמצעות bcrypt ואינן נשמרות בגרסתן המקורית</li>
                        <li><strong style={{ color: 'white' }}>בקרת גישה:</strong> גישה למסד הנתונים מוגנת באמצעות מדיניות Row Level Security (RLS) שמבטיחה שכל משתמש יכול לגשת אך ורק למידע שלו</li>
                        <li><strong style={{ color: 'white' }}>מפתחות API:</strong> מפתחות גישה לשירותים חיצוניים נשמרים בצד השרת בלבד (משתני סביבה) ואינם חשופים בקוד הלקוח</li>
                        <li><strong style={{ color: 'white' }}>אימות:</strong> מערכת אימות מבוססת Supabase Auth עם תמיכה בטוקנים מאובטחים</li>
                    </ul>
                    <p>
                ...
                <Section title="8. שמירת מידע">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li><strong style={{ color: 'white' }}>נתוני חשבון:</strong> נשמרים כל עוד החשבון פעיל. עם מחיקת החשבון, המידע יימחק תוך 30 יום</li>
                        <li><strong style={{ color: 'white' }}>נתוני למידה והתקדמות:</strong> נשמרים כל עוד החשבון פעיל, על מנת לאפשר המשכיות בלמידה</li>
                        <li><strong style={{ color: 'white' }}>נתוני אנליטיקה:</strong> נשמרים באופן מצטבר ואנונימי למשך 24 חודשים</li>
                        <li><strong style={{ color: 'white' }}>נתונים מקומיים:</strong> חלק מהנתונים נשמרים ב-localStorage בדפדפן שלך. ניתן למחוק אותם בכל עת דרך הגדרות הדפדפן או דרך מסך ההגדרות באפליקציה</li>
                    </ul>
                </Section>
                ...
                <Section title="9. זכויות המשתמש">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li><strong style={{ color: 'white' }}>זכות עיון:</strong> הזכות לקבל מידע על המידע האישי שאנו מחזיקים אודותיך</li>
                        <li><strong style={{ color: 'white' }}>זכות תיקון:</strong> הזכות לתקן מידע שגוי או לא מדויק</li>
                        <li><strong style={{ color: 'white' }}>זכות מחיקה:</strong> הזכות לבקש מחיקת המידע האישי שלך ומחיקת חשבונך</li>
                        <li><strong style={{ color: 'white' }}>זכות הגבלה:</strong> הזכות לבקש הגבלת עיבוד המידע שלך</li>
                        <li><strong style={{ color: 'white' }}>זכות ניידות:</strong> הזכות לקבל את המידע שלך בפורמט מובנה ומכונה-קריא</li>
                        <li><strong style={{ color: 'white' }}>זכות התנגדות:</strong> הזכות להתנגד לעיבוד המידע למטרות שיווק ישיר</li>
                    </ul>
                    <p>
                ...
                <Section title="10. עוגיות וטכנולוגיות מעקב">
                    ...
                    <ul style={{ margin: '8px 0', paddingRight: 20 }}>
                        <li>
                            <strong style={{ color: 'white' }}>עוגיות חיוניות:</strong> עוגיות הנדרשות לתפקוד מערכת האימות
                            ולשמירת מצב ההתחברות שלך. ללא עוגיות אלה, לא ניתן יהיה להשתמש בשירות
                        </li>
                        <li>
                            <strong style={{ color: 'white' }}>אנליטיקה (Vercel Analytics):</strong> איסוף נתונים אנונימיים על ביצועי האפליקציה
                ...
                <Section title="11. קטינים">
                    <p>
                        האפליקציה מיועדת למשתמשים מגיל <strong style={{ color: 'white' }}>16 ומעלה</strong>.
                ...
                <Section title="13. יצירת קשר">
                    ...
                    <div style={{
                        ...
                        <p style={{ margin: '0 0 4px', fontSize: 14 }}>
                            <strong style={{ color: 'white' }}>הרשות להגנת הפרטיות</strong>
                        </p>
